...
public class FlappyBird extends JPanel implements ActionListener, KeyListener {
    ...
    int pipeY = 0;
    int pipeWidth = 64; // dimensionado em 1/6
    int pipeHeight = 512;
    ...
    class Pipe {
     ...
     //game logic
     Bird bird;
     int velocityX = -30; //move os tubos para a velocidade esquerda (simula o movimento do pássaro para a direita)
     int velocityY = 0; //move a velocidade do pássaro para cima/para baixo.
     int gravity = 1;
    ...
    //load images
    backgroundImg = new ImageIcon(getClass().getResource("./FunndoBlackFlappyBird.png")).getImage();
 ...
 public boolean collision(Bird a, Pipe b) {
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_SPACE) {
           velocityY = -9;
           if (gameOver) {
               //reinicia o jogo redefinindo as condições
               bird.y = birdY;
               velocityY = 0;
               pipes.clear();
               score = 0;
